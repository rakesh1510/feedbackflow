  ...
  <div class="container hero">
    <div class="grid-2">
      <div class="card">
        ...
        <p>FeedbackFlow helps small businesses add a feedback widget to any website, collect ratings and comments, customize the button, and review everything in one simple dashboard.</p>
        <p>
      ...
      <div class="card">
        ...
        <ol>
          ...
          <li>Customize widget settings</li>
